 ...
 */
package com.servicemesh.agility.adapters.core.azure.action;
...
public class TestStatusPoller
{
    ...
    private class Poller extends StatusPoller<PollerResponse>
    {
        ...
        public Poller(Request request, long interval, long retries, String
                      desiredState, AzureConnection conn, boolean retryOn404)
        {
        ...
        public boolean getUpdateResponseAbort()
        {
            return _updateResponseAbort;
        }        
    ...
    public void testPoller() throws Exception
    {
        ...
        mockConn = mock(AzureConnection.class);
        ...
        _runAbort = true;
        status = Status.FAILURE;
        TestHelpers.setLogLevel(Poller.class.getName(), Level.OFF);
        doFire("Polling status exception 1", poller, false, status);
        TestHelpers.setLogLevel(Poller.class.getName(), Level.DEBUG);
        _runAbort = false;
    ...
    private Poller doConstruct(String scenario, Request request,
                               ...
                               AzureConnection conn, boolean retryOn404,
                               boolean throwing)
    {
                        ...
                        boolean throwing, Status status) throws Exception
    {
        ...
        try {
            if (throwing || poller.getUpdateResponseAbort())
                TestHelpers.setLogLevel(Poller.class.getName(), Level.OFF);
